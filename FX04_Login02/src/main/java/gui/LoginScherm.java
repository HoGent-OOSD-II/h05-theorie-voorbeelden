...
public class LoginScherm extends GridPane {
	...
	public LoginScherm() {
		...
		btnSignIn.setOnAction(this::buttonPushed); // <1>
		btnCancel.setOnAction(evt -> lblMessage.setText("Cancel button pressed")); // <2>
		linkForgot.setOnAction(new EventHandler<ActionEvent>() // <3>
		{
			@Override
	...
	private void buttonPushed(ActionEvent event) // <4>
	{
