...
public class MenuScherm extends BorderPane {
	...
	private ToolBar buildToolBar() {
		...
		btnRed.setOnAction(e -> middenPaneel.setStyle("-fx-background-color: rgb(255,0,0)"));
		Button btnGreen = new Button("Green");
		btnGreen.setOnAction(e -> middenPaneel.setStyle("-fx-background-color: rgb(0,255,0)"));
		Button btnBlue = new Button("Blue");
		btnBlue.setOnAction(e -> middenPaneel.setStyle("-fx-background-color: rgb(0,0,255)"));

		ToolBar toolBar = new ToolBar(new Label("Background color: "), btnRed, btnGreen, btnBlue);
